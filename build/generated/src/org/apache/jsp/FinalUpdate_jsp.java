  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("           ");
              ...
              String bkaname;
              String bkpub;
             bkid=Integer.parseInt(session.getAttribute("bkid").toString());
             bkname = request.getParameter("txtname");
             bkaname = request.getParameter("txtaname");
             bkprice = Integer.parseInt(request.getParameter("txtprice"));
             bkpub = request.getParameter("txtpub");
             B.setbid(bkid);
             B.setbname(bkname);
             B.setbaname(bkaname);
             B.setbprice(bkprice);
             ...
             if(bd.updateBook(B)>0)
                 out.println("<font color=green size=6>Record Updated</font>");
             else
                  out.println("<font color=red size=6>Record Not Updated</font>");
